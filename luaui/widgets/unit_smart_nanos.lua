...
function widget:GetInfo()
  return {
    name      = "SmartNanos",
    desc      = "Enables auto reclaim & repair for idle nano turrets 1.4",
...
if (Game.modShortName == "TA") then local BA = true end 
...
function widget:UnitFinished(unitID, unitDefID, unitTeam)
  ...
  if UnitDefs[unitDefID].customParams.iscommander then myTeamID = GetMyTeamID() end
