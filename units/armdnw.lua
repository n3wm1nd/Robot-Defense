...
local unitDef = {
  ...
  description        = [[Egocentric avatar of War]],
...
local featureDefs = {
  Dead = {
    ...
    category           = [[corpses]],
    damage             = 266666,
    description        = [[Wrecked Deadnight Warrior]],
    featureDead        = [[fallen]],
  ...
  fallen = {
    ...
    category           = [[corpses]],
    damage             = 106666,
    description        = [[Fallen Deadnight Warrior]],
    featureDead        = [[heap]],
    featurereclamate   = [[smudge01]],
    footprintX         = 12,
    footprintZ         = 15,
  ...
  heap = {
    ...
    category           = [[heaps]],
    damage             = 42666,
    description        = [[Deadnight Warrior Heap]],
    featurereclamate   = [[smudge01]],
    footprintX         = 7,
    footprintZ         = 7,
    height             = 4,
